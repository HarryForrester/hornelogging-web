  ...
  */
  const handleClose = () => {
    if(skidModalState.isSelectHazardsGeneral){
      setSkidModalState((prevState) => ({ ...prevState, isSelectHazardModalVisible: false, isGeneralHazardsModalVisible: true }));

    } else {
      setSkidModalState((prevState) => ({ ...prevState, isSelectHazardModalVisible: false, isSkidModalVisible: true }));
  ...
  return (
      <Modal show={skidModalState.isSelectHazardModalVisible} onHide={handleClose}>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={() => submitHazards(selectedHazards)}>Save changes</Button>
        </Modal.Footer>
      </Modal>
  );
};
